...
import za.co.retrorabbit.piecommander.fragments.dummy.DummyContent.DummyItem;
...
public class BluetoothDeviceRecyclerViewAdapter extends RecyclerView.Adapter<BluetoothDeviceRecyclerViewAdapter.ViewHolder> {
    ...
    public BluetoothDeviceRecyclerViewAdapter(List<DummyItem> items, DeviceFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
